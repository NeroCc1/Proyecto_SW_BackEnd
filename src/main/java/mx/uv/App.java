...
public class App {
    ...
    public static void main(String[] args) {
        ...
        get("/parques", (req, res) -> {
            ...
            return gson.toJson(DAO.damenombres());
        });
        /*
        post("/", (req, res) -> {
            String datosCliente = req.body();
            String id = UUID.randomUUID().toString();
            parques u = gson.fromJson(datosCliente, parques.class);
            u.setId(id);
        ...
        post("/existe", (req, res) -> {
            ...
            List<parques> x = DAO.damenombres();
            for (parques xUsuario : DAO.damenombres()) {
